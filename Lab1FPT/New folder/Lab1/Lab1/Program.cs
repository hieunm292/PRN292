...
namespace Lab1
{
    ...
    {
        Point[] list { get; set; }
        public PolyLine(Point p, Point[] list) : base(p)
        {
            this.list = list;
        }
    ...
    class Program
    {
        ...
        {
            Shape l1 = new Line(new Point(0, 0));
            l1.move(new Point(2, 3));
            l1.Show();

            Circle c1 = new Circle(new Point(0, 0));
            c1.move(new Point(3, 4));
            c1.Show();

            Rectangle r1 = new Rectangle(new Point(0, 0));
            r1.move(new Point(5, 15));
            r1.Show();
